...
namespace ClashTheCube
{
    ...
    public class CubeSpawner : MonoBehaviour
    {
        ...
        private void MergeCubeEffect(CubeController cube)
        {
            var loadedParticlePrefab = Instantiate(mergeParticlePrefab);
            loadedParticlePrefab.transform.position = cube.transform.position;
            loadedParticlePrefab.transform.parent = cube.transform;
            var particleSystem = loadedParticlePrefab.GetComponent<ParticleSystem>();
            particleSystem.Play();
        }
